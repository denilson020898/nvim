...
vim.keymap.set("n", "<F15>", "<cmd>resize 100<cr>", { noremap = true })
...
vim.keymap.set("n", "<F2>", "<cmd>FocusMaxOrEqual<cr>", { noremap = true })
...
vim.keymap.set('n', '<S-F11>', '<cmd>lua require"dap".step_out()<cr>', { noremap = true })
...
-- vim.keymap.set('n', '=K', '<cmd>lua require"dap.ui.widgets".hover()<cr>', { noremap = true })
...
vim.keymap.set('n', '=R', require"dap".repl.toggle, { noremap = true })
