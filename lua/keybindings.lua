...
vim.keymap.set("n", "--", "<cmd>BufferLinePick<cr>", { noremap = true })
...
vim.keymap.set("n", "<space>bw", function() require('close_buffers').wipe({ type = 'all', force = true }) end, { noremap = true })
vim.keymap.set("n", "<space>bo", function() require('close_buffers').wipe({ type = 'other' }) end, { noremap = true })
vim.keymap.set("n", "<space>bh", function() require('close_buffers').delete({ type = 'hidden', force = true }) end, { noremap = true })
vim.keymap.set("n", "<space>bn", function() require('close_buffers').delete({ type = 'nameless' }) end, { noremap = true })
...
vim.keymap.set("n", "<space>te", "<cmd>Telescope file_browser<cr>", { noremap = true })
...
vim.keymap.set("n", "<S-F5>", "<cmd>checktime<cr>", { noremap = true })
...
vim.keymap.set("n", "<space>go", "<cmd>DiffviewClose<cr>", { noremap = true })
...
vim.keymap.set("n", "<A-a>", require('myplugins.spectre').search_resume, { noremap = true })
...
vim.keymap.set("n", "<space>sa", "<cmd>lua require('spectre').open({path='*py *xml *js'})<cr>", { noremap = true })
...
vim.keymap.set("n", "<space>pC", "<cmd>HopChar1<cr>", { noremap = true })
vim.keymap.set('n', '<space>u', require("memento").toggle, { noremap = true })
vim.keymap.set('n', '<space>U', require("memento").clear_history, { noremap = true })
...
vim.keymap.set('n', '=k', "<cmd>lua local widgets=require'dap.ui.widgets';widgets.centered_float(widgets.scopes)<cr>", { noremap = true })
...
vim.keymap.set('n', '<A-v>', '<cmd>lua require"dap".set_breakpoint(vim.fn.input("Breakpoint condition: "))<cr>' , { noremap = true })
vim.keymap.set('n', '<A-c>', '<cmd>lua require"dap".set_breakpoint(nil, nil, vim.fn.input("Log point message: "))<cr>', { noremap = true })
