...
vim.keymap.set("n", "<F36>", "<cmd>PackerSync<cr>", {})
vim.keymap.set("n", "<C-F12>", "<cmd>PackerSync<cr>", {})
vim.keymap.set("n", "<F6>", "<cmd>lua require'colorscheme'.toggle_theme()<cr>", {})
vim.keymap.set("n", "<F5>", "<cmd>checktime<cr>", {})
vim.keymap.set("n", "<F4>", "<cmd>AerialToggle!<cr>", { noremap = true })
vim.keymap.set("n", "<F3>", "<cmd>IndentBlanklineToggle<cr>", {})
vim.keymap.set("n", "<F13>", "<cmd>lua require'settings'.switch_foldmethod()<cr>", { silent = true })
