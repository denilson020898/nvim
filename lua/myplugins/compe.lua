...
vim.api.nvim_set_keymap("i", "/", "compe#confirm('/')", {expr = true, noremap=true})
vim.api.nvim_set_keymap("i", "<c-f>", "compe#confirm({ 'keys': '<c-f>', 'select': v:true })", { expr = true })
vim.api.nvim_set_keymap("i", "<C-d>", "compe#scroll({ 'delta': +4 })", {expr = true, noremap=true})
vim.api.nvim_set_keymap("i", "<C-u>", "compe#scroll({ 'delta': -4 })", {expr = true, noremap=true})
